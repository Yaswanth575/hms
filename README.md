![App picture](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/main_picture.jpg)
...
```
git clone https://github.com/margiki/HMS-nodejs-webapp
```
...
![Dashboard](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/dashboard.jpg)

![Dashboard](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/dasboard_2.jpg)
...
![Add patient page](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/add_new_patient.jpg)

### Patient page

Double click on a patient name on the dashboard to get here.
![Patient page](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/patient_page.jpg)
...
![System Settings](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/system_settings.jpg)
...
### Backend
![Nodejs - ExpressJS](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/backend.jpg)

### Frontend
![jQuery](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/frontend.jpg)

### Database
![MongoDB - Mongoose](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/database.jpg)

### Databse Schema
![Database schema](https://github.com/margiki/HMS-nodejs-webapp/blob/master/github_readme_photos/database_design.jpg)

**The available application is connected to a MongoDB database online.** If you want to change the database to another one, you need to go: HMS app folder -> server -> db -> mongoose.js

Inside the file, you need to change the database link from
mongoose.connect("mongodb://admin:admin123@ds145220.mlab.com:45220/hms-app"); to mongoose.connect("your-database-link");
